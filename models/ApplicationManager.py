...
class ApplicationManager:
    ...
    @classmethod
    def create_app(cls, algod_client, private_key, approval_program, clear_program, global_schema, local_schema, app_args):
        """
    ...
    @classmethod
    def call_app(cls, algod_client, private_key, index, app_args):
        """
    ...
    @classmethod
    def opt_in_app(cls, algod_client, private_key, index):
        """
    ...
    @classmethod
    def delete_app(cls, algod_client, private_key, index):
        """
    ...
    @classmethod
    def clear_app(cls, algod_client, private_key, index):
        """
    ...
    @classmethod
    def close_out_app(cls, algod_client, private_key, index):
        """
